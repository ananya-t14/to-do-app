...
mocha.describe('updateTask', () => {
  // Successfully update an existing task
  mocha.it('should update an existing task when valid data is provided', async () => {
  ...
  mocha.it('should return the updated task document when valid data is provided', async () => {
    // Mock the request parameters and body
    const req = {
      params: { username: 'testuser', title: 'Task 1' },
      body: { title: 'Updated Task 1', description: 'Updated description', status: true },
  ...
  // User not found
  mocha.it('should return an error response when user is not found', async () => {
    // Mock the request parameters and body
    const req = {
      params: { username: 'testuser', title: 'Task 1' },
      body: { title: 'Updated Task 1', description: 'Updated description', status: true },
  ...
  // Task does not exist
  mocha.it('should return an error response when task does not exist', async () => {
    // Mock the request parameters and body
    const req = {
      params: { username: 'testuser', title: 'Task 1' },
      body: { title: 'Updated Task 1', description: 'Updated description', status: true },
  ...
  mocha.it('should return an error response when required fields are missing', async () => {
  ...
  mocha.it('should update only specific fields of the task document when valid data is provided', async () => {
    // Mock the request parameters and body
    const req = {
      params: { username: 'testuser', title: 'Task 1' },
